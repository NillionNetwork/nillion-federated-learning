...
from examples.neural_net_5.dataset import load_datasets
from examples.neural_net_5.model import NeuralNet as Net
...
def run(client_id):
    NUM_CLIENTS = 5  # Number of clients in the federated network
